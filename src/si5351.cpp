...
bool Si5351::init(uint8_t xtal_load_c, uint32_t xo_freq, int32_t corr)
{
  ...
  //reg_val = Wire.endTransmission();
    ...
    //{
        ...
        status_reg = si5351_write(SI5351_CRYSTAL_LOAD, (xtal_load_c & SI5351_CRYSTAL_LOAD_MASK) | 0b00010010);
...
//    return i2c.write(addr,(char*) data,bytes);
    ...
    //{
    //    i2c.byte_write(data[i]);
    //}
    //return Wire.endTransmission();

}

uint8_t Si5351::si5351_write(uint8_t reg, uint8_t data)
{
    char data_a[2];
    data_a[0] = reg;
    data_a[1] = data;
...
uint8_t Si5351::si5351_read(uint8_t reg)
{
    ...
    return (uint8_t) data_read[0];//reg_val;
}
